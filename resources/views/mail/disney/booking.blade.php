                ...
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding: 0 30px 20px">
                            <p style="margin-bottom: 10px;">Hi <strong>{{ $mailData->disney->first_name }} {{ $mailData->disney->last_name }}</strong>,</p>
                    ...
                    <tr>
                        <td style="padding: 20px 30px 40px">
                            ...
                            <div><strong>Vehicle type :</strong> @if($mailData->disney->passengers>=5 && $mailData->disney->passengers <8 && $mailData->disney->vehicle_type=='car')
                                Economy Class Van
                                @elseif($mailData->disney->passengers>=5 && $mailData->disney->passengers <8 && $mailData->disney->vehicle_type=='van')
                                                                     Business Class Van
                                @else
                                    {{strtoupper($mailData->disney->vehicle_type??'N/A')}}
                            @endif
                            </div>
