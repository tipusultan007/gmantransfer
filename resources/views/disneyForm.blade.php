...
<head>
    ...
    <style>
        ...
        .btn-primary {
            --bs-btn-color: #fff;
            --bs-btn-bg: #FD8D3B;
            --bs-btn-border-color: #FD8D3B;
            --bs-btn-hover-color: #fff;
            --bs-btn-hover-bg: #FD8D3B;
            --bs-btn-hover-border-color: #FD8D3B;
            --bs-btn-focus-shadow-rgb: 124, 139, 255;
            --bs-btn-active-color: #fff;
            --bs-btn-active-bg: #FD8D3B;
            --bs-btn-active-border-color: #FD8D3B;
            --bs-btn-active-shadow: inset 0 3px 5px rgba(16, 25, 36, 0.125);
            --bs-btn-disabled-color: #fff;
            --bs-btn-disabled-bg: #FD8D3B;
            --bs-btn-disabled-border-color: #FD8D3B;
        }
        .progress-bar.stepper-progress-bar {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <ul class="custom-control-group custom-control-horizontal w-100">
                                                        ...
                                                        <li>
                                                            <div class="custom-control custom-control-sm custom-radio custom-control-pro">
                                                                <input type="radio" class="custom-control-input" name="payment_method_id" value="4" id="cardPayment">
                                                        ...
                                                        <li>
                                                            <div class="custom-control custom-control-sm custom-radio custom-control-pro">
                                                                <input type="radio" class="custom-control-input" name="payment_method_id" value="3" id="bankPayment">
