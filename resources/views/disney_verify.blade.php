                ...
                <div class="nk-split nk-split-page nk-split-lg">
                    ...
                    <div
                        ...
                        <div class="wide-xs-fix">
                            <form action="{{ url('updateBookingDisney') }}">
                                @csrf
                                @method('PATCH')
                                <input type="hidden" name="id" value="{{ $details->disney_id }}">
                                <div class="form-group">
                                    <label class="form-label" for="">Booking Reference No</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" name="ref" value="{{ 'DC'.$details->disney_id }}" readonly>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="email" class="form-control" name="email" value="{{ $details->disney->email }}" readonly>
                                    </div>
